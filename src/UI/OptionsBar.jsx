...
export default function OptionsBar() {
  return (
    <nav className="flex w-[100%] items-center justify-between gap-12 bg-slate-100 px-14 py-2 ">
      ...
      <div className=" flex items-center">
        ...
        <select
          className="  flex justify-center gap-1 rounded-sm bg-[#9adf9a]  px-2 py-1 text-xl shadow-sm outline-none transition-all hover:bg-green-500 hover:text-slate-100"
          name="sort"
          id="sort"
        >
